...
// configurei com o método verbose() o sqlite para que apareça as msgs do banco no terminal 

const db = new sqlite3.Database("./src/database/database.db") 
// Outra forma de criar um objeto, new inicia um outro objeto desde que o que se está 
// sendo retornar seja um construtor/classe cria o bando de dados no caminho designado
